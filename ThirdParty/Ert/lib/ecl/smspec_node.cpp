    ...
    case('L'):
      ...
      default:
        /*
          ...
          category; at least the LINEAR keyword is an example of such
          a keyword.
        */
        var_type = ECL_SMSPEC_MISC_VAR;
      }
...
bool smspec_node_identify_total(const char * keyword, ecl_smspec_var_type var_type) {
 /*
    ...
    The list below is all the keywords with 'Total' in the information from
...
/*
  ...
  2. Observe that the LGR variables are not thoroughly checked; the only check
     ...
     that is therefore just assumed to be right.
  ...
  */
  ...
  case(ECL_SMSPEC_MISC_VAR):
    ...
    /*
       ...
       for the generated summaryfiles to display nicely in
       e.g. S3GRAF.
    */
