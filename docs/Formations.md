...
See [Annotations on plots](Formations#annotations-on-plot). Annotations are added to plots in the same way as for k-layered formations, but the source is different.
