...
<div class="note">
The main window also has a snapshot toolbar containing the button [Snapshot All Views]({{ sit.baseurl }}/docs/snapshots#snapshot-all-viewsplots-to-file-). This button will include a snapshot of the Grid Statistics dialog if opened.
