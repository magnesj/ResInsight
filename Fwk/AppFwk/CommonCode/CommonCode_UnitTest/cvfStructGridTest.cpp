...
{
    EXPECT_EQ( StructGridInterface::GridAxisType::AXIS_I,
               StructGridInterface::gridAxisFromFace( StructGridInterface::POS_I ) );
    EXPECT_EQ( StructGridInterface::GridAxisType::AXIS_I,
               StructGridInterface::gridAxisFromFace( StructGridInterface::NEG_I ) );
    EXPECT_EQ( StructGridInterface::GridAxisType::AXIS_J,
               StructGridInterface::gridAxisFromFace( StructGridInterface::POS_J ) );
    EXPECT_EQ( StructGridInterface::GridAxisType::AXIS_J,
               StructGridInterface::gridAxisFromFace( StructGridInterface::NEG_J ) );
    EXPECT_EQ( StructGridInterface::GridAxisType::AXIS_K,
               StructGridInterface::gridAxisFromFace( StructGridInterface::POS_K ) );
    EXPECT_EQ( StructGridInterface::GridAxisType::AXIS_K,
               StructGridInterface::gridAxisFromFace( StructGridInterface::NEG_K ) );
    EXPECT_EQ( StructGridInterface::GridAxisType::NO_AXIS,
               StructGridInterface::gridAxisFromFace( StructGridInterface::NO_FACE ) );
}
...
public:
    ...
    {
        return i + j * m_cellCountI + k * m_cellCountI * m_cellCountJ;
    }
