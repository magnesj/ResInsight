...
"                                                                                                                   \n"
"                                                                                                                   \n"
"// The following are all mutually exclusive macros for various separable blurs of varying kernel size              \n"
...
"    sum += textureProjOffset(u_shadowMap, offShadowCoord, ivec2(0, -1));                              \n"
"                                                                                                      \n"
"    // shadowFactor 0..1 (0 not in shadow, 1 totally in shadow)                                        \n"
...
"                                                                                                         \n"
"// Prototypes not needed when we concatenate files, and these breaks the compile on VMWare Fusion 4.0.4  \n"
"// vec4 srcFragment();                                                                                   \n"
"// vec4 lightFragment(vec4 srcFragColor, float shadowFactor);                                            \n"
"                                                                                                         \n"
"//--------------------------------------------------------------------------------------------------     \n"
