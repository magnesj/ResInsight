...
RiaRegressionTest::RiaRegressionTest()
{
    ...
    folderContainingCompareTool.uiCapability()->setAttribute<bool>( "m_selectDirectory", true );
    folderContainingCompareTool.uiCapability()->setAttribute<bool>( "m_selectDirectory", true );
    ...
    folderContainingDiffTool.uiCapability()->setAttribute<bool>( "m_selectDirectory", true );
    folderContainingDiffTool.uiCapability()->setAttribute<bool>( "m_selectDirectory", true );
    ...
    folderContainingGitTool.uiCapability()->setAttribute<bool>( "m_selectDirectory", true );
    folderContainingGitTool.uiCapability()->setAttribute<bool>( "m_selectDirectory", true );
    ...
    regressionTestFolder.uiCapability()->setAttribute<bool>( "m_selectDirectory", true );
    regressionTestFolder.uiCapability()->setAttribute<bool>( "m_selectDirectory", true );
