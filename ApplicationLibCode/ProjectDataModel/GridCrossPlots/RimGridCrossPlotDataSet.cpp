...
RimGridCrossPlotDataSet::RimGridCrossPlotDataSet()
{
    ...
    m_xAxisProperty = new RimEclipseResultDefinition( caf::PdmUiItemInfo::LabelPosition::TOP );
    ...
    m_yAxisProperty = new RimEclipseResultDefinition( caf::PdmUiItemInfo::LabelPosition::TOP );
