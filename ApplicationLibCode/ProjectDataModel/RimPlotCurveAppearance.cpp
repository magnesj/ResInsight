    ...
    , m_curveFittingToleranceVisible( true )
{
    ...
    m_curveColorOpacity.uiCapability()->setAttribute<double>( "m_minimum", 0.0 );
    m_curveColorOpacity.uiCapability()->setAttribute<double>( "m_maximum", 1.0 );
    m_curveColorOpacity.uiCapability()->setAttribute<int>( "m_decimals", 2 );
    ...
    m_fillColorOpacity.uiCapability()->setAttribute<double>( "m_minimum", 0.0 );
    m_fillColorOpacity.uiCapability()->setAttribute<double>( "m_maximum", 1.0 );
    m_fillColorOpacity.uiCapability()->setAttribute<int>( "m_decimals", 2 );
