...
void RimStatisticsContourMap::defineUiOrdering( QString uiConfigName, caf::PdmUiOrdering& uiOrdering )
{
    ...
    if ( computeOK )
    {
        uiOrdering.addNewButton( "Compute", computeCallback, "Start statistics computations." );
    }
    else
    {
        uiOrdering.addNewButton( "Compute", computeCallback, "Please check your time step and/or formation filter selections." );
    }
