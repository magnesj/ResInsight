...
{
    if ( changedField == &m_referencePointUtmXyd )
    {
...
void RimWellPathGeometryDef::defineUiOrdering( QString uiConfigName, caf::PdmUiOrdering& uiOrdering )
{
    ...
    uiOrdering.addNewButton( m_pickPointsEnabled ? "Stop Picking Points" : "Pick Points",
                            [this]()
                            {
                                m_pickPointsEnabled = !m_pickPointsEnabled;
                                updateConnectedEditors();
                            } );
