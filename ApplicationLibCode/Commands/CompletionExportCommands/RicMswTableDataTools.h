...
// Deprecated: tree-based collection functions — use RicWellPathExportMswGeometryPath::collectDataFromFlatList() instead.
...
[[deprecated( "Use RicWellPathExportMswGeometryPath::collectDataFromFlatList() instead" )]]
