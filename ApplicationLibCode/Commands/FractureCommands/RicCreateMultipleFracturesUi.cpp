...
RiuCreateMultipleFractionsUi::RiuCreateMultipleFractionsUi()
{
    ...
    m_options.uiCapability()->setAttribute<int>( "minimumHeight", 130 );
    ...
    m_fractureCreationSummary.uiCapability()->setAttribute<int>( "wrapMode", caf::PdmUiTextEditorAttribute::NoWrap );
}
...
///
//--------------------------------------------------------------------------------------------------
void RiuCreateMultipleFractionsUi::defineCustomContextMenu( const caf::PdmFieldHandle* fieldNeedingMenu, QMenu* menu, QWidget* fieldEditorWidget )
{
...
QString RiuCreateMultipleFractionsUi::summaryText() const
{
...

    {
        ...
        {
            header.push_back(
                RifTextDataTableColumn( fracTemplate->name(), RifTextDataTableDoubleFormatting(), RifTextDataTableAlignment::RIGHT ) );
        }
