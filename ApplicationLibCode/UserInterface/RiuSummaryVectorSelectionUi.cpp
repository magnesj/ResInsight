    ...
    , m_showIndividualEnsembleCases( true )
{
    ...
    m_selectedSummaryCategories.uiCapability()->setAttribute<bool>( "showTextFilter", false );
    m_selectedSummaryCategories.uiCapability()->setAttribute<bool>( "showToggleAllCheckbox", false );
...
void RiuSummaryVectorSelectionUi::defineUiOrdering( QString uiConfigName, caf::PdmUiOrdering& uiOrdering )
{
    ...
    m_selectedSources.uiCapability()->setAttribute<bool>( "singleSelectionMode", !m_multiSelectionMode, uiConfigName );
    m_selectedSummaryCategories.uiCapability()->setAttribute<bool>( "singleSelectionMode", !m_multiSelectionMode, uiConfigName );
    ...
    for ( const auto& itemTypes : m_identifierFieldsMap )
    {
        for ( const auto& itemInputType : itemTypes.second )
        {
            itemInputType->pdmField()->uiCapability()->setAttribute<bool>( "singleSelectionMode", !m_multiSelectionMode, uiConfigName );
        }
    }
