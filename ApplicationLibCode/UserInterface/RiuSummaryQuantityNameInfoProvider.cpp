    ...
    RiuSummaryQuantityNameInfoProvider::createInfoForEclipseKeywords()
{
    ...
    /*
       ...
       ); info.insert( { "GGLIR", { A::SUMMARY_GROUP, "Gas Lift Injection Rate" } } ); info.insert( { "GGCV", { A::SUMMARY_GROUP, "Gas
       Calorific Value" } } ); info.insert( { "GGQ", { A::SUMMARY_GROUP, "Gas molar Quality" } } ); info.insert( { "GEPR", {
       A::SUMMARY_GROUP, "Energy Production Rate" } } ); info.insert( { "GEPT", { A::SUMMARY_GROUP, "Energy Production Total" } } );
       ...
       } } ); info.insert( { "GPRBW", { A::SUMMARY_GROUP, "Pressure drop along the group's or node's inlet branch in the water injection
       network" } } ); info.insert( { "GALQ", { A::SUMMARY_GROUP, "ALQ in the group's or node's outlet branch in the production network" } }
       ); info.insert( { "GOPRNB", { A::SUMMARY_GROUP, "Oil flow rate along the group's or node's outlet branch in the production network" }
       } ); info.insert( { "GWPRNB", { A::SUMMARY_GROUP, "Water flow rate along the group's or node's outlet branch in the production
       network" } } ); info.insert( { "GGPRNB", { A::SUMMARY_GROUP, "Gas flow rate along the group's or node's outlet branch in the
       production network" } } ); info.insert( { "GLPRNB", { A::SUMMARY_GROUP, "Liquid flow rate along the group's or node's outlet branch
       in the production network" } } ); info.insert( { "GWIRNB", { A::SUMMARY_GROUP, "Water flow rate along the group's or node's inlet
       branch in the water injection network" } } ); info.insert( { "GGIRNB", { A::SUMMARY_GROUP, "Gas flow rate along the group's or node's
       inlet branch in the gas injection network" } } ); info.insert( { "GOMNR", { A::SUMMARY_GROUP, "Group or node minimum oil rate as
       specified with GNETDP in the production network" } } ); info.insert( { "GGMNR", { A::SUMMARY_GROUP, "Group or node minimum gas rate
       as specified with GNETDP in the production network" } } ); info.insert( { "GWMNR", { A::SUMMARY_GROUP, "Group or node minimum water
       rate as specified with GNETDP in the production network" } } ); info.insert( { "GLMNR", { A::SUMMARY_GROUP, "Group or node minimum
       liquid rate as specified with GNETDP in the production network" } } ); info.insert( { "GOMXR", { A::SUMMARY_GROUP, "Group or node
       maximum oil rate as specified with GNETDP in the production network" } } ); info.insert( { "GGMXR", { A::SUMMARY_GROUP, "Group or
       node maximum gas rate as specified with GNETDP in the production network" } } ); info.insert( { "GWMXR", { A::SUMMARY_GROUP, "Group
       or node maximum water rate as specified with GNETDP in the production network" } } ); info.insert( { "GLMXR", { A::SUMMARY_GROUP,
       "Group or node maximum liquid rate as specified with GNETDP in the production network" } } ); info.insert( { "GMNP", {
       ...
       } } ); info.insert( { "COPR", { A::SUMMARY_WELL_COMPLETION, "Oil Production Rate" } } ); info.insert( { "COPT", {
       A::SUMMARY_WELL_COMPLETION, "Oil Production Total" } } ); info.insert( { "COPTF", { A::SUMMARY_WELL_COMPLETION, "Free Oil Production
       Total" } } ); info.insert( { "COPTS", { A::SUMMARY_WELL_COMPLETION, "Solution Oil Production Total" } } ); info.insert( { "COIT", {
       A::SUMMARY_WELL_COMPLETION, "Oil Injection Total" } } ); info.insert( { "COPP", { A::SUMMARY_WELL_COMPLETION, "Oil Potential
       Production rate" } } ); info.insert( { "COPI", { A::SUMMARY_WELL_COMPLETION, "Oil Potential Injection rate" } } ); info.insert( {
       "CWFR", { A::SUMMARY_WELL_COMPLETION, "Water Flow Rate" } } ); info.insert( { "CWFRU", { A::SUMMARY_WELL_COMPLETION, "Sum of
       connection water flow rates upstream of, and including, this connection" } } ); info.insert( { "CWPR", { A::SUMMARY_WELL_COMPLETION,
       "Water Production Rate" } } ); info.insert( { "CWPT", { A::SUMMARY_WELL_COMPLETION, "Water Production Total" } } ); info.insert( {
       "CWIR", { A::SUMMARY_WELL_COMPLETION, "Water Injection Rate" } } ); info.insert( { "CWIT", { A::SUMMARY_WELL_COMPLETION, "Water
       Injection Total" } } ); info.insert( { "CWPP", { A::SUMMARY_WELL_COMPLETION, "Water Potential Production rate" } } ); info.insert( {
       "CWPI", { A::SUMMARY_WELL_COMPLETION, "Water Potential Injection rate" } } ); info.insert( { "CGFR", { A::SUMMARY_WELL_COMPLETION,
       "Gas Flow Rate" } } ); info.insert( { "CGFRF", { A::SUMMARY_WELL_COMPLETION, "Free Gas Flow Rate" } } ); info.insert( { "CGFRS", {
       A::SUMMARY_WELL_COMPLETION, "Solution Gas Flow Rate" } } ); info.insert( { "CGFRU", { A::SUMMARY_WELL_COMPLETION, "Sum of connection
       gas flow rates upstream of, and including, this connection" } } ); info.insert( { "CGPR", { A::SUMMARY_WELL_COMPLETION, "Gas
       Production Rate " } } ); info.insert( { "CGPT", { A::SUMMARY_WELL_COMPLETION, "Gas Production Total" } } ); info.insert( { "CGPTF", {
       A::SUMMARY_WELL_COMPLETION, "Free Gas Production Total" } } ); info.insert( { "CGPTS", { A::SUMMARY_WELL_COMPLETION, "Solution Gas
       Production Total" } } ); info.insert( { "CGIR", { A::SUMMARY_WELL_COMPLETION, "Gas Injection Rate" } } ); info.insert( { "CGIT", {
       A::SUMMARY_WELL_COMPLETION, "Gas Injection Total" } } ); info.insert( { "CGPP", { A::SUMMARY_WELL_COMPLETION, "Gas Potential
       Production rate" } } ); info.insert( { "CGPI", { A::SUMMARY_WELL_COMPLETION, "Gas Potential Injection rate" } } ); info.insert( {
       "CGQ", { A::SUMMARY_WELL_COMPLETION, "Gas Quality" } } ); info.insert( { "CLFR", { A::SUMMARY_WELL_COMPLETION, "Liquid Flow Rate" } }
       ); info.insert( { "CLPT", { A::SUMMARY_WELL_COMPLETION, "Liquid Production Total" } } ); info.insert( { "CVFR", {
       A::SUMMARY_WELL_COMPLETION, "Reservoir" } } ); info.insert( { "CVPR", { A::SUMMARY_WELL_COMPLETION, "Res Volume Production Rate" } }
       ); info.insert( { "CVPT", { A::SUMMARY_WELL_COMPLETION, "Res Volume Production Total" } } ); info.insert( { "CVIR", {
       A::SUMMARY_WELL_COMPLETION, "Res Volume Injection Rate" } } ); info.insert( { "CVIT", { A::SUMMARY_WELL_COMPLETION, "Res Volume
       Injection Total" } } ); info.insert( { "CWCT", { A::SUMMARY_WELL_COMPLETION, "Water Cut" } } ); info.insert( { "CGOR", {
       A::SUMMARY_WELL_COMPLETION, "Gas-Oil Ratio" } } ); info.insert( { "COGR", { A::SUMMARY_WELL_COMPLETION, "Oil-Gas Ratio" } } );
        ...
        info.insert( { "COFRU", { A::SUMMARY_WELL_COMPLETION, "Sum of connection oil flow rates upstream of, and including, this connection"
       } } ); info.insert( { "CWFRU", { A::SUMMARY_WELL_COMPLETION, "Sum of connection water flow rates upstream of, and including, this
       connection" } } ); info.insert( { "CGFRU", { A::SUMMARY_WELL_COMPLETION, "Sum of connection gas flow rates upstream of, and
       including, this connection" } } ); info.insert( { "LCOFRU", { A::SUMMARY_WELL_COMPLETION, "As COFRU but for local grids" } } );
        ...
        info.insert( { "BWSHY", { A::SUMMARY_BLOCK, "Departure saturation from drainage to imbibition for water capillary pressure
       hysteresis" } } ); info.insert( { "BWSMA", { A::SUMMARY_BLOCK, "Maximum wetting saturation for water capillary pressure hysteresis" }
       } ); info.insert( { "BMLSC", { A::SUMMARY_BLOCK, "Hydrocarbon molar density" } } ); info.insert( { "BMLST", { A::SUMMARY_BLOCK,
       "Total hydrocarbon molar density" } } ); info.insert( { "BMWAT", { A::SUMMARY_BLOCK, "Water molar density" } } ); info.insert( {
       "BROMLS", { A::SUMMARY_BLOCK, "Residual oil moles/ reservoir volume" } } ); info.insert( { "BJV", { A::SUMMARY_BLOCK, "In" } } );
        ...
        info.insert( { "LBHDF_X",
                       { A::SUMMARY_BLOCK, "Hydraulic head at freshwater conditions interpolated at a defined coordinate within a local
       grid" } } ); info.insert( { "LBSCN_X", { A::SUMMARY_BLOCK, "Brine concentration interpolated at a defined coordinate within a local
       grid" } } ); info.insert( { "LBCTRA_X", { A::SUMMARY_BLOCK, "Tracer concentration interpolated at a defined coordinate within a local
       grid" } } ); info.insert( { "BOKRX", { A::SUMMARY_BLOCK, "Oil relative permeability in the X direction" } } ); info.insert( {
       "BOKRX", { A::SUMMARY_BLOCK, "- Oil relative permeability in the -X direction" } } ); info.insert( { "BOKRY", { A::SUMMARY_BLOCK,
       "Oil relative permeability in the Y direction" } } ); info.insert( { "BOKRY", { A::SUMMARY_BLOCK, "- Oil relative permeability in the
       ...
       ); info.insert( { "BVELW0J", { A::SUMMARY_BLOCK, "Water velocity in the positive J direction multiplied by the corresponding shear
       multiplier" } } ); info.insert( { "BVELW0K", { A::SUMMARY_BLOCK, "Water velocity in the positive K direction multiplied by the
       corresponding shear multiplier" } } ); info.insert( { "BPSHLZI", { A::SUMMARY_BLOCK, "Viscosity multiplier due to sheared water flow
       in the positive I direction" } } ); info.insert( { "BPSHLZJ", { A::SUMMARY_BLOCK, "Viscosity multiplier due to sheared water flow in
       the positive J direction" } } ); info.insert( { "BPSHLZK", { A::SUMMARY_BLOCK, "Viscosity multiplier due to sheared water flow in the
       positive K direction" } } ); info.insert( { "BSRTW0I", { A::SUMMARY_BLOCK, "Water shear rate in the positive I direction prior to
       shear effects" } } ); info.insert( { "BSRTW0J", { A::SUMMARY_BLOCK, "Water shear rate in the positive J direction prior to shear
       effects" } } ); info.insert( { "BSRTW0K", { A::SUMMARY_BLOCK, "Water shear rate in the positive K direction prior to shear effects" }
       ...
       } ); info.insert( { "BKRWOT", { A::SUMMARY_BLOCK, "Opposite saturation direction turning point relative permeability to water for
       water-oil system" } } ); info.insert( { "BKROGT", { A::SUMMARY_BLOCK, "Opposite saturation direction turning point relative
       permeability to oil for oil-gas system" } } ); info.insert( { "BKRGOT", { A::SUMMARY_BLOCK, "Opposite saturation direction turning
       point relative permeability to gas for gas-oil system" } } ); info.insert( { "BKRGWT", { A::SUMMARY_BLOCK, "Opposite saturation
       direction turning point relative permeability to gas for gas-water system" } } ); info.insert( { "BKRWGT", { A::SUMMARY_BLOCK,
       "Opposite saturation direction turning point relative permeability to water for water-gas system" } } ); info.insert( { "BIFTOW", {
       A::SUMMARY_BLOCK, "Oil-water interfacial tension" } } ); info.insert( { "BIFTWO", { A::SUMMARY_BLOCK, "Water-oil interfacial tension"
       } } ); info.insert( { "BIFTOG", { A::SUMMARY_BLOCK, "Oil-gas interfacial tension" } } ); info.insert( { "BIFTGO", { A::SUMMARY_BLOCK,
       "Gas-oil interfacial tension" } } ); info.insert( { "BIFTGW", { A::SUMMARY_BLOCK, "Gas-water interfacial tension" } } ); info.insert(
       { "BIFTWG", { A::SUMMARY_BLOCK, "Water-gas interfacial tension" } } ); info.insert( { "BPCOWR", { A::SUMMARY_BLOCK, "Representative
       oil-water capillary pressure" } } ); info.insert( { "BPCWOR", { A::SUMMARY_BLOCK, "Representative water-oil capillary pressure" } }
       ); info.insert( { "BPCOGR", { A::SUMMARY_BLOCK, "Representative oil-gas capillary pressure" } } ); info.insert( { "BPCGOR", {
       A::SUMMARY_BLOCK, "Representative gas-oil capillary pressure" } } ); info.insert( { "BPCGWR", { A::SUMMARY_BLOCK, "Representative
       gas-water capillary pressure" } } ); info.insert( { "BPCWGR", { A::SUMMARY_BLOCK, "Representative water-gas capillary pressure" } }
       );
